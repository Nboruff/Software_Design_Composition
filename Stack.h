...
public:
   ...
   */
  //RESPONSE When looking into std::exception i found that it does not 
  //have a constructor that takes in a message of any kind so for this to work
  //I changed what error it inherited from so that we could use a message. otherwise passing
  //a message to this class throws an error at compile time.
